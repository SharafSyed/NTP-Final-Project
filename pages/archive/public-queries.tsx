...
const navigation = [
  ...
  { name: 'Public Queries', href: '/archive/public-queries', current: true },
]
...
const Dashboard: NextPage = () => {
  ...
  useEffect(() => {
    ...
    axios(`${process.env.NEXT_PUBLIC_API_URL}/queries/archive/public/list/tweets?limit=5`).then(res => {
      if (res.data.status === 200) {
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500 dark:text-stone-300">
                          View this query and all it's contents?
                        </p>
                      </div>
                    </div>
                  </div>
    ...
    {/* Dashboard Start */}
      <div className="h-screen bg-white dark:bg-stone-900">
        ...
        <main className="p-2 grid overflow-hidden grid-cols-4 grid-rows-5 gap-2">
          ...
          <div className="row-span-4 min-w-full min-h-full">
